    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-my-favorite-recipe">
          <li>Put sushi rice.</li>
          <li>Add dressing-marinade.</li>
          <li>Place raw tune or other sashimi-grade fish.</li>
      ...
      <div id="wd-anchor">
        ...
        Link to Hejia's Code Repository&nbsp;
        <a id="wd-github" href="https://github.com/lihejia09/kanbas-react-web-app-2024su2">code repository</a>
      </div>
    </div>
  );
}
